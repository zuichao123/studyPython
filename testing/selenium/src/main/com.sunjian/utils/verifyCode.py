...
def main():
    ...
    #下载图片
    image1=get_image(driver, "//div[contains(@class,'geetest_canvas_img')]/div/canvas[1]")
    image2=get_image(driver, "//div[contains(@class,'geetest_canvas_img')]/div/canvas[2]")
    #计算缺口位置
    loc=get_diff_location(image1, image2)
    #生成x的移动轨迹点
    track_list=get_track(loc)
    #找到滑动的圆球
    element=driver.find_element_by_xpath("//div[contains(@class,'geetest_slider geetest_ready')]/div[2]")
