...
class CrackGeetest():
    ...
    def open(self):
        ...
        email = self.wait.until(EC.presence_of_element_located((By.XPATH, "//form//input[@type='email']")))
        password = self.wait.until(EC.presence_of_element_located((By.XPATH, "//form//input[@type='password']")))
