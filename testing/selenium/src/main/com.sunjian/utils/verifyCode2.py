...
def get_image(driver):
    ...
    img=driver.find_element_by_xpath("//div[contains(@class,'geetest_canvas_img')]")
...
def crack(driver): #破解滑动认证
    ...
    button2 = driver.find_element_by_class_name('geetest_slider_button')
    ActionChains(driver).click_and_hold(button2).perform()
    # 滑过了,然后开始反向滑动
    time.sleep(0.5)
    print('----------------2')
...
def login_cnblogs(username,password):
    ...
    try:
        ...
        input_username = driver.find_element_by_xpath("//form[@id='loginForm']/div[1]/input")
        input_pwd = driver.find_element_by_xpath("//form[@id='loginForm']/div[2]/input")
        signin = driver.find_element_by_xpath("//form[@id='loginForm']//button")
...
if __name__ == '__main__':
    login_cnblogs(username='15510211823',password='sunjian123!@#')