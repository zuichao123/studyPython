    ...
    for event in pygame.event.get():
        ...
        if event.type == MOUSEBUTTONDOWN:
            ...
            if key_pressed[pygame.K_a] or key_pressed[pygame.K_LEFT]:
                print('left')
                hero_temp.move_left(True)
            #检测按键是否是d或者right
            elif key_pressed[pygame.K_d] or key_pressed[pygame.K_RIGHT]:
                print('right')
                hero_temp.move_right(True)
            #检测按键是否是空格键
            elif event.key == K_SPACE or event.type == MOUSEBUTTONDOWN:
                print('space')
                hero_temp.fire()
        elif event.type == KEYUP:
            if event.key == pygame.K_a or event.key == pygame.K_LEFT:
                print('stop_left')
                hero_temp.move_left(False)
            # 检测按键是否是d或者right
            elif event.key == pygame.K_d or event.key == pygame.K_RIGHT:
                print('stop_right')
                hero_temp.move_right(False)
