...
# Scrapy settings for bandaoSpider project
#
...
BOT_NAME = 'bandaoSpider'

SPIDER_MODULES = ['bandaoSpider.spiders']
NEWSPIDER_MODULE = 'bandaoSpider.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'bandaoSpider (+http://www.yourdomain.com)'
...
#SPIDER_MIDDLEWARES = {
#    'bandaoSpider.middlewares.BandaospiderSpiderMiddleware': 543,
#}

# Enable or disable downloader middlewares
# See https://doc.scrapy.org/en/latest/topics/downloader-middleware.html
#DOWNLOADER_MIDDLEWARES = {
#    'bandaoSpider.middlewares.BandaospiderDownloaderMiddleware': 543,
#}
...
ITEM_PIPELINES = {
   'bandaoSpider.pipelines.BandaospiderPipeline': 300,
}
